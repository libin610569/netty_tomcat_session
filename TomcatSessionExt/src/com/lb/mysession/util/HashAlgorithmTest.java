...
public class HashAlgorithmTest {
	...
	/** key's count */
	private static final Integer EXE_TIMES = 100000; //模拟 key 10w
	
	private static final Integer NODE_COUNT = 3;//服务器总共 5个
	 
	private static final Integer VIRTUAL_NODE_COUNT = 160;//虚拟节点
	...
	public static void main(String[] args) {
		...
		KetamaNodeLocator locator = new KetamaNodeLocator(allNodes, HashAlgorithm.KETAMA_HASH, 2000);
		...
		System.out.println(locator.getPrimary("4F104221F509C0DAA752D05E61F16F11"));
		System.out.println(locator.getPrimary("5F104221F509C0DAA752D05E61F16F11"));
