...
public class SetCommand extends AbstractCommand {
	...
	public SetCommand(AttributeBean attributeBean ){
		super();
	...
	public Object getSendObject() {
		...
		msgBuilder.setProtokey(COMMAND_SET);
		msgBuilder.setSessionId(attribute.getId()); 
		msgBuilder.setDataType("obj");
		...
		msgBuilder.setValue(ObjectUtil.ObjectToByteString(attribute.getValue()));
